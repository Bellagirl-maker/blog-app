...
```sh
  git clone https://github.com/Bellagirl-maker/blog-app.git
```
...
I would like to thank [Microverse](https://bit.ly/MicroverseTN) for the opportunity to work on this project.
